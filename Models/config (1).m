function cs = config()
% MATLAB function for configuration set generated on 19-Oct-2025 16:26:15
...
cs.set_param('FunctionInliningControlUserFunctions', 'Speed');   % Function inlining between user functions
cs.set_param('FunctionInliningControlMWFunctions', 'Speed');   % Function inlining between MathWorks functions
cs.set_param('FunctionInliningControlMWUserFunctions', 'Speed');   % Function inlining between user and MathWorks functions
...
cs.set_param('UnifyBufferReuse', 'off');   % Unify buffer reuse candidates
...
cs.set_param('OptimizeBlockOrder', 'speed');   % Optimize block operation order in generated code
...
cs.set_param('CustomSymbolStrType', '$N$R$M_sT');   % Global types
...
cs.set_param('CustomSymbolStrMacro', '$N$M[U]');   % Constant macros
...
cs.set_param('CombineOutputUpdateFcns', 'off');   % Single output/update function
...
cs.set_param('PreserveMATLABNamespacesInGeneratedCode', 'on');   % Preserve MATLAB namespaces in generated code
...
cs.set_param('ParenthesesLevel', 'Minimum');   % Parentheses level

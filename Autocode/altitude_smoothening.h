...
} B_altitude_smoothening_sT;

/* Real-time Model Data Structure */
struct tag_RTM_altitude_smoothening_sT {
  B_altitude_smoothening_sT *blockIO;
};

/* Model entry point functions */
extern void altitude_smoothening_initialize(RT_MODEL_altitude_smoothening_sT *
  const altitude_smoothening_M, uint8_T *altitude_smoothening_U_startaltitude,
  uint8_T *altitude_smoothening_U_totaltime, uint8_T
  *altitude_smoothening_U_currenttime, uint8_T
  *altitude_smoothening_U_targetaltitude, uint16_T
  *altitude_smoothening_Y_desiredaltitude);
extern void altitude_smoothening_output(RT_MODEL_altitude_smoothening_sT *const
  ...
  *altitude_smoothening_Y_desiredaltitude);
extern void altitude_smoothening_update(RT_MODEL_altitude_smoothening_sT *const
...
/*-
 * Requirements for '<Root>': altitude_smoothening
